...
#define VERSION_ip2location "8.0.4"
#define MIN_VERSION_ip2location(major1,major2,minor) (\
  (major1) <  8 || \
  (major1) == 8 && (major2) <  0 || \
  (major1) == 8 && (major2) == 0 && (minor) <= 4)
...
#define CURRENT_COMPONENT_ID "ip2location-8.0.4-EJEn3Sdeyj18D0gbXKZdU8"

#define CURRENT_PACKAGE_KEY "ip2location-8.0.4-EJEn3Sdeyj18D0gbXKZdU8"
