...
myst_html_meta = {
    "description": "IP2Location Haskell package provides a fast lookup of geolocation information from IP address by using IP2Location database.",
    "keywords": "IP2Location, Geolocation, IP location, Haskell",
...
html_title = "IP2Location Haskell"

# html_baseurl = "https://ip2location-haskell.readthedocs.io/en/latest/"